...
class AStarFinder {
    getMapArray() { return this.m_grid.getGrid(); }
    constructor(_grid, _diagonalAllowed) {
    ...
    findPath(startPosition, endPosition) {
        ...
        let neighbors = [];
        let nodePositionWithLowestFValue = [];
        ...
        for (let y = 0; y < this.m_mapHeight; y++) {
            for (let x = 0; x < this.m_mapWidth; x++) {
                /* If NOT walkable */
        ...
        while (!_.isEmpty(this.m_openList)) {
            ...
            if (currentNode === endNode) {
                ...
                return Util_1.backtrace(endNode);
            }
            /* get neighbors */
            ...
            for (let i in neighbors) {
                ...
                if (!neightbor.getIsOnOpenList() || nextGValue < neightbor.getGValue()) {
                    ...
                    neightbor.setHValue(Heuristic_1.getManhattenDistance(abs(xPos - xEndPos), abs(yPos - yEndPos)) * this.m_movementCostNotDiagonal);
                    neightbor.setFValue();
...
//# sourceMappingURL=AStarFinder.js.map